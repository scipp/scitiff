...
# Suppress highlighting failure warning to allow backslash \ in the command line cli
# example in the cli.ipynb notebook.
suppress_warnings = [*suppress_warnings, "misc.highlighting_failure"]
